...
(function () {
  ...
  function isExcludedSlug(slug) {
    return slug === 'index' || slug === 'smart-print' || slug === 'pdf-compressor' || slug === 'photo-print-4x6' || slug === 'scanner' || slug === 'aadhar-kendra' || slug === 'digital-dalan' || slug === 'digital-wall' || slug === 'book-wall' || slug === 'logo-wall' || slug === 'news_paper';
  }
  ...
  function getFormCleanTitle(slug) {
    var map = {
      ...
      'caste-affidavit': 'जातीचे प्रमाणपत्र प्रतिज्ञापत्र व वंशावळ',
